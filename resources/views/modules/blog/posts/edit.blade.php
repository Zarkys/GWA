    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-10">
                        <h6 class="m-0 font-weight-bold text-primary">Actualizar Entrada</h6>
                    </div>
                    <div class="col-md-2">
...
<script>
    ...
    var app = new Vue({
        ...
        mounted() {
            ...
            RoutePost_BACK('{{route('blog.post.consult')}}', form).then(
                response => {
                    if (response.data.code !== 500) {
                        ...
                        this.datepublication = response.data.data.publication_date;
                        this.tagSelect = response.data.data.tagArray;
                        ...
                        if (this.tagSelect.length > 0) {
                            Swal.fire({
                                ...
                                if (result.value) {
                                    ...
                                    RoutePost_BACK('{{route('blog.post.update')}}', form).then(
                                        response => {
                                            if (response.data.code !== 500) {
                                                Swal.fire(
                                                    'Listo',
