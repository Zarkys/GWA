    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-10">
                        <h6 class="m-0 font-weight-bold text-primary">Actualizando el Tipo de Producto</h6>
                    </div>
                    <div class="col-md-2">
...
<script>
    ...
    var app = new Vue({
        ...
        mounted() {
            ...
            RoutePost_BACK('{{route('product.type.consult')}}', form).then(
                response => {
                    ...
                    if (result) {
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                RoutePost_BACK('{{route('product.type.update')}}', form).then(
                                    response => {
