...
<div class="container-fluid">
    ...
    <p class="mb-4">En esta lista puedes visualizar todos los comentarios que existen actualmente </p>
...
<script>
    var app = new Vue({
        ...
        methods: {
            ...
            trashRow(idelement){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                            ...
                            trashElement('coment/change/delete/'+idelement, '').then(
                                    response => {
                                        if (response.data.code !== 500) {                          
            ...
            checkRow(idelement){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        inactiveElement('coment/change/inactive/'+idelement, '').then(
                                    response => {
                                        if (response.data.code !== 500) {                          
                                           // this.typeattributes = response.data.data; 
                                           Swal.fire(
            ...
            activeRow(idelement){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        activeElement('coment/change/active/'+idelement, '').then(
                                    response => {
                                        if (response.data.code !== 500) {                          
                                           // this.typeattributes = response.data.data; 
                                           Swal.fire(
            ...
            updateRow(idelement)
            {
                window.location.href = 'comments/update/'+idelement;
            },
            cleanform() {
