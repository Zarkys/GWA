...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Agregar una Categoría de Entrada</h1>
    </div>      
        ...
        <div class="card shadow mb-4">
            ...
            <div class="row">
                <div class="col-md-8">
                <h6 class="m-0 font-weight-bold text-primary">Agregar Categoría de Entrada</h6>
                </div>
                <div class="col-md-4">
            ...
            <form>
                <div class="row">
                    ...
                    <input type="text" class="form-control" id="inputName" v-model="name_type" aria-describedby="nameHelp" placeholder="Nombre de la Categoría de Entrada">
                     </div>
                    </div>
                    <div class="col-md-6">
                            <div class="form-group">
