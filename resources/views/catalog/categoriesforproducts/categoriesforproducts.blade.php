...
<div class="container-fluid">
    ...
    <p class="mb-4">En esta lista puedes visualizar todas las categorías de productos que existen actualmente </p>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                <a href="categoriesforproducts/new" class="btn btn-primary btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-plus"></i>
                    </span>
                    <span class="text">Nueva categoría de producto</span>
                  </a>
                </div>
            </div>
            ...
            <ul class="list-group">
                ...
                <ul class="list-group">
                    ...
                    <div class="col-md-4">
                    @{{categoryforproduct.description}}
                    </div>
                    <div class="col-md-2">
                    <a href="#" v-on:click="updateRow(categoryforproduct.id)" class="btn btn-primary btn-circle">
...
<script>
    var app = new Vue({
            ...
            loadElements('categoryforproduct', '').then(
                    response => {
                        if (response.data.code !== 500) {
                            ...
                            console.log(this.categoriesforproducts);
        ...
        methods: {
            ...
            updateRow(idelement)
            {
                window.location.href = 'categoriesforproducts/update/'+idelement;
            },
            cleanform() {
