        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="{{route('blog.category.list')}}" class="btn btn-warning btn-icon-split">
...
<script>
    ...
    var app = new Vue({
        ...
        mounted() {
            ...
            RoutePost_BACK('{{route('blog.category.consult')}}', form).then(
                response => {
                    ...
                    if (result) {
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                RoutePost_BACK('{{route('blog.category.update')}}', form).then(
                                    response => {
                                        if (response.data.code === 200) {
                                            ...
                                            Swal.fire(
                                                ...
                                                window.location.href = '{{route('blog.category.list')}}';
                                            });
