    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-10">
                        <h6 class="m-0 font-weight-bold text-primary">Actualizar Doctor</h6>
                    </div>
                    <div class="col-md-2">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="name" id="name" name="name"
                                       ...
                                       placeholder="Nombre del doctor" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <span v-show="errors.has('consulting_room')"
...
<script>
    ...
    var app = new Vue({
        ...
        mounted() {
                    ...
                    if (response.data.code !== 500) {
                        ...
                        if (this.specialtyArray.length === 0) {
                            Swal.fire(
                                ...
                                window.location.href = '{{route('doctors.doctor.create')}}';
                            });
                        }
            ...
            RoutePost_BACK('{{route('doctors.doctor.consult')}}', form).then(
                response => {
                    if (response.data.code !== 500) {
                        this.name = response.data.data.name;
                        this.consulting_room = response.data.data.consulting_room;
                        this.phone = response.data.data.phone;
                        this.specialty = response.data.data.specialty;
                    } else {
                    ...
                    if (result) {
                            Swal.fire({
                                ...
                                if (result.value) {
                                    ...
                                    RoutePost_BACK('{{route('doctors.doctor.update')}}', form).then(
                                        response => {
                                            if (response.data.code !== 500) {
                                                Swal.fire(
                                                    'Listo',
