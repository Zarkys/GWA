    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-md-10">
                        <h6 class="m-0 font-weight-bold text-primary">Actualizando la Especialidad</h6>
                    </div>
                    <div class="col-md-2">
                        <a href="{{route('doctors.specialty.list')}}" class="btn btn-warning btn-icon-split">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input v-model="name" v-validate="'required'" class="form-control"
                                       ...
                                       name="name" id="name" placeholder="Nombre de la especialidad">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input v-model="description" v-validate="'required'" class="form-control"
                                       ...
                                       name="description" id="description" placeholder="Descripcion de la especialidad">
...
<script>
    ...
    var app = new Vue({
        ...
        mounted() {
            ...
            RoutePost_BACK('{{route('doctors.specialty.consult')}}', form).then(
                response => {
                    ...
                    if (result) {
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                RoutePost_BACK('{{route('doctors.specialty.update')}}', form).then(
                                    response => {
                                        if (response.data.code === 200) {
                                            ...
                                            Swal.fire(
                                                ...
                                                window.location.href = '{{route('doctors.specialty.list')}}';
                                            });
